...
public class TelegramChannelPostMetadataRequestFactory {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            Верни только JSON:
            {
              ...
              "eventDateText": "точная цитата даты проведения мероприятия или null",
            ...
            eventDateText — только дата проведения мероприятия, не дата публикации и не срок регистрации.
            deadlineText — срок подачи заявки, регистрации или сдачи документов, не дата мероприятия.
            Если указаны и регистрация до 5 августа, и мероприятие 10 августа, сохрани их в разных полях.
            eventDateText тоже копируй дословно. Не добавляй год, если автор его не указал.
            Уточнение только о месте или времени без календарной даты не получает eventDateText.
